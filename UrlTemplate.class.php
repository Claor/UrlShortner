...
{
    private $skeleton, $serv_name, $url;
    ...
    link ($code)
    {
        return str_replace (
                array ('{:TITLE:}',
                    '{:CONTENT:}'),
                array ($this->serv_name . " - Generate",
                    str_replace (
                        array ('{:SHORT_LINK:}',
                            '{:PREVIEW_LINK:}'),
                        array ($this->url . $code,
                            $this->url . "preview-" . $code),
    ...
    preview ($code)
    {
        return str_replace (
            array ('{:TITLE:}',
                '{:CONTENT:}'),
            array ($this->serv_name . " - Preview",
                str_replace ('{:PREVIEW_LINK:}', $code,
                    $this->readTemplate ('preview'))),
            $this->skeleton);
    }
}
?>
